...
@implementation GTTimeProfiler

+ (GTTimeProfiler *)sharedTimeProfiler
{
    static dispatch_once_t onceToken;
    static GTTimeProfiler *profiler = nil;
    dispatch_once(&onceToken, ^{
        profiler = [[GTTimeProfiler alloc] initTimeProfilerWithMainKey:@""];
    });
    return profiler;
}
...
- (void)saveTimeProfileDataIntoFile:(NSString *)fileName
{
    ...
    GTLog(@"TMTimeProfiler::SaveFilePath is %@", filePath);
