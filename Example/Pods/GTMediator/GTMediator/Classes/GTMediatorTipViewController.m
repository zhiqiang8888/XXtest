...
@interface GTMediatorTipViewController ()
...
@implementation GTMediatorTipViewController
...
+(nonnull UIViewController *)paramsErrorTipController{
    GTMediatorTipViewController *controller = [[GTMediatorTipViewController alloc] init];
